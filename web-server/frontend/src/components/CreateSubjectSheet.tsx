...
const CreateSubjectSheet: React.FC = () => {
  ...
  const [loading, setLoading] = React.useState(false) // Loading state for professor VM creation
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('')
    setInvalidStudentEmails([])
    // Start loading state for professor VM creation
    setLoading(true)
    try {
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              This may take up a bit of time. Please wait...
            </p>
          </div>
        ) : (
          <ScrollArea className="h-full pr-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="professorEmails">
                  Other Professors' Emails
                </Label>
              ...
              <div className="border-t pt-4">
                ...
                <div className="mt-4">
                  ...
                  />
                  <p className="mt-1 text-sm text-muted-foreground">
                    If enabled, you will be able to configure the virtual
                    machine before creating the template. This allows you to
                    install additional software and configure the system
